...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {axis_tx} \
   CONFIG.FREQ_HZ {156250000} \
 ] $tx_clk_out
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC DEFAULT $tx_clk_out
  ...
  connect_bd_net -net rx_reset_0_0_1 [get_bd_ports reset_rtl_0] [get_bd_pins xxv_ethernet_0/rx_reset_0] [get_bd_pins xxv_ethernet_0/tx_reset_0]
  ...
  connect_bd_net -net xxv_ethernet_0_user_rx_reset_0 [get_bd_pins clk_wiz/reset] [get_bd_pins rst_clk_wiz_100M/ext_reset_in] [get_bd_pins xxv_ethernet_0/user_rx_reset_0]
