...
*/
#ifndef BACKENDS_P4FPGA_PACKETEXTERNTRANSLATE_H_
#define BACKENDS_P4FPGA_PACKETEXTERNTRANSLATE_H_
...
class PacketExternTranslate : public PassManager{
 public:
    PacketExternTranslate(P4::ReferenceMap* refMap, P4::TypeMap* typeMap,
...
#endif  // BACKENDS_P4FPGA_PACKETEXTERNTRANSLATE_H_
